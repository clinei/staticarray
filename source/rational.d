...
struct Rational
{
    public
    {
        ...
        bool opEquals(T)(T y) pure const nothrow if (!is(Unqual!T == Rational))
        {
            return this == Rational(y);
        }

        bool opEquals(T)(T o) pure const nothrow if (is(Unqual!T == Rational))
        {
        ...
        int opCmp(T)(T o) pure const nothrow if (is(Unqual!T == Rational))
        {
            assert(denom > 0);
            assert(o.denom > 0);
